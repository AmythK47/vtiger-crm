...
public class CreateOrgwithIndustryTest {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Industry Name : " + orgIndustry);
		
		if(co.getVerifyIndustry().getText().equals(orgIndustry))
			System.out.println(orgIndustry + " Industry Name verified ===> PASS");
		else
			System.out.println(orgIndustry + " Industry Name Not verified ===> FAIL");
